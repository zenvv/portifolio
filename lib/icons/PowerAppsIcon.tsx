...
function PowerAppsIcon({ width = "1em", height = "1em", ...props }: IconProps) {
    ...
    return (
        ...
        >
            <defs>
                ...
                <linearGradient id={paint0} x1="71" y1="96.0002" x2="15" y2="-40.9998" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#742774" />
                    <stop offset="1" stopColor="#BB35A4" />
                </linearGradient>
                <linearGradient id={paint1} x1="32" y1="0.0002436" x2="78" y2="96.0002" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#E48CC7" />
                    <stop offset="1" stopColor="#D467B9" />
                </linearGradient>
                <linearGradient id={paint2} x1="62" y1="29.0002" x2="76" y2="72" gradientUnits="userSpaceOnUse">
            ...
            <g clipPath={`url(#${clip0})`}>
                <g clipPath={`url(#${clip1})`}>
                    <g clipPath={`url(#${clip2})`}>
                        ...
                        <g mask={`url(#${mask0})`}>
                            <path d="M40 96L-2 48L40 0L82 48L40 96Z" fill={`url(#${paint0})`} />
