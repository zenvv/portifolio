...
function PowerAutomateSolidIcon({ width = "1em", height = "1em", ...props }: IconProps) {
    return (
        <svg
            width={width}
            height={height}
