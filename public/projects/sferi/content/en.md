...
![Empty canvas, dark mode](/projects/sferi/images/1-overview.png)
...
![Editing a fill color on the selected text layer](/projects/sferi/images/2-editing.png)

**A finished layout.** Frame, text, star and ellipse, each its own entry in the layers panel on the left.

![Finished layout with the layers panel listing every object](/projects/sferi/images/3-layout.png)

**The frame, cropped.** The same layout, isolated to just the 512x512 frame.

![Cropped view of the finished frame](/projects/sferi/images/4-poster.png)
